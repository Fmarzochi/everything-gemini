---
name: everything-gemini-conventions
description: Development conventions and patterns for everything-gemini. JavaScript project with conventional commits.
...
# Everything Gemini Conventions

> Generated from [fmarzochi/everything-gemini](https://github.com/fmarzochi/everything-gemini) on 2026-03-20

## Overview

This skill teaches Gemini the development patterns and conventions used in everything-gemini.
...
```text
fix: auto-detect ECC root from plugin cache when GEMINI_PLUGIN_ROOT is unset (#547) (#691)
```
...
```text
feat: add block-no-verify hook for Gemini CLI and Cursor (#649)
```
